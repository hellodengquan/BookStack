...
return [
    ...
    'updated_page_debounce' => 'Да би смо спречили масовна обавештења, неко времевам неће бити слата обавештења за измене ове стране од стране истог уредника.',
    'comment_mention_subject' => 'Поменути сте у коментару на страни: :pageName',
    'comment_mention_intro' => 'Поменути сте у коментару на :appName:',
    ...
    'footer_reason' => 'Ово обавештење вам је послато зато што :link покрива ове типове активности за ову ставку.',
    'footer_reason_link' => 'ваше преференце за обавештавања',
];
